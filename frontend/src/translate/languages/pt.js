    ...
    translations: {
      ...
      settings: {
        ...
        settings: {
          ...
          groups: {
            name: "Receber mensagem de grupos",
            options: {
              enabled: "Ativado",
              disabled: "Desativado",
            },
          ...
          typebotRestart: {
            name: "Palavra para Reiniciar",
          },
          typebotOff: {
            name: "Palavra para Desligar",
          },
          typebotTime: {
            name: "Tempo para Reativar",
          },
          emailUser: {
            name: "Usuário Gmail",
          },
          emailPass: {
            name: "Senha de App (Gmail)",
          },
          emailFrom: {
            name: "Usuário Gmail (from)",
          },
          emailTo: {
            name: "Email destino",
          },
