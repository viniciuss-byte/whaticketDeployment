    ...
    translations: {
      ...
      settings: {
        ...
        settings: {
          ...
          groups: {
            name: "Recibir mensaje de grupos",
            options: {
              enabled: "Habilitado",
              disabled: "Deshabilitado",
            },
          ...
          typebotName: {
              name: "Nombre de Typebot",
          },
          typebotRestart: {
              name: "Palabra para Reiniciar",
          },
          typebotOff: {
              name: "Palabra para Apagar",
          },
          typebotTime: {
              name: "Tiempo para Reactivar",
          },
          emailUser: {
              name: "Usuario Gmail",
          },
          emailPass: {
              name: "Contraseña de App (Gmail)",
          },
          emailFrom: {
              name: "Usuario Gmail (from)",
          },
          emailTo: {
              name: "Correo electrónico de destino",
          },
          vonageApiKey: {
            name: "Vonage API KEY",
          },
