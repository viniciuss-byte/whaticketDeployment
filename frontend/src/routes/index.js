...
import Connections02 from "../pages/Connections02";
import  QRCodeIframe from '../components/QRCodeIframe';
    ...
    <BrowserRouter>
      ...
      <AuthProvider>
        <Switch>
          ...
          <Route exact path="/connections02" component={Connections02} />
          <Route path="/qrcode" component={QRCodeIframe} />
